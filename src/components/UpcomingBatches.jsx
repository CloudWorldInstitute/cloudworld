...
const UpcomingBatches = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-orange-50 via-amber-50 to-emerald-50 min-h-screen">
      <div className="container mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-12">
          <span className="inline-block bg-orange-200 text-orange-700 px-4 py-1 rounded-full text-sm font-semibold mb-4">
            🚀 Join Our Next Cohort
          </span>
          <h2 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-600 mb-4">
            Upcoming Batches
          </h2>
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          {filteredBatches.map((batch, index) => (
            <div
              key={batch.id}
              className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border-l-4 border-orange-500 overflow-hidden group"
            >
              <div className="flex flex-col lg:flex-row">
                ...
                {/* Right Section - CTA */}
                <div className="lg:w-64 bg-gradient-to-br from-orange-50 to-amber-50 p-6 flex flex-col justify-center gap-3 border-t lg:border-t-0 lg:border-l border-orange-100">
                  <Link to={`/course/${batch.courseId}`}>
                    <button className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white py-3 px-4 rounded-lg font-semibold hover:from-orange-600 hover:to-amber-600 transition-all hover:scale-105 shadow-md text-sm">
                      📖 View Course
                    </button>
                  </Link>
                  ...
                  <a
                    ...
                    className="block w-full text-center border-2 border-orange-500 text-orange-600 py-3 px-4 rounded-lg font-semibold hover:bg-white transition-all text-sm"
                  >
                    💬 Enroll Now
                  </a>
        ...
        {/* Bottom CTA */}
        <div className="mt-16 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 rounded-2xl p-8 max-w-4xl mx-auto text-white shadow-2xl">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:scale-105 transition-transform shadow-lg"
              >
