        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-100 text-gray-900 py-16 px-6">
            ...
            <div className="sticky top-20 ml-20 z-20 my-5 flex justify-">
                <nav className="relative">
                    <button
                        ...
                        className="px-6 py-3 rounded-full bg-gradient-to-r from-orange-500 to-amber-400 text-white font-semibold shadow-md transition hover:scale-105 hover:shadow-lg flex items-center gap-2 min-w-[220px] justify-between"
                    >
                    ...
                    {isDropdownOpen && (
                        <>
                            <div className="absolute top-full mt-2 left-0 w-64 bg-white rounded-xl shadow-xl border border-orange-100 overflow-hidden z-30">
                                <button
                                    onClick={() => handleCategorySelect('All Categories')}
                                    className={`w-full px-6 py-3 text-left transition-colors ${selectedCategory === 'All Categories'
                                            ? 'bg-gradient-to-r from-orange-50 to-amber-50 text-orange-600 font-semibold'
            ...
            <section className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                {currentBlogs.map((blog) => (
                    ...
                    >
                        ...
                        />
                        <div className="p-6">
                            <div className="flex justify-between items-center text-sm text-amber-600 font-medium mb-3">
                        ...
                        {/* Comments Section */}
                        <div className="bg-gradient-to-br from-amber-50 to-orange-100 px-6 py-4 border-t border-amber-200 max-h-32 overflow-y-auto">
                            {blog.comments.map((c, i) => (
                                <div key={i} className="border-b border-amber-300/50 py-1 last:border-0">
            ...
            <div className="flex justify-center items-center gap-3 mt-16 text-amber-700 font-medium max-w-6xl mx-auto">
                <button
                    ...
                    className={`px-4 py-2 rounded-md border border-orange-400 ${currentPage === 1
                ...
                {[...Array(totalPages)].map((_, idx) => {
                    ...
                    return (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg border border-orange-400 ${pageNum === currentPage
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-md border border-orange-400 ${currentPage === totalPages
                        ? "opacity-40 cursor-not-allowed"
