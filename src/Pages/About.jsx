        ...
        <div className="container mx-auto px-4 relative z-10 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-indigo-600 to-violet-600 text-teal-100 rounded-2xl p-6 shadow-2xl animate-bounce-slow">
                <div className="text-center">
            ...
            <div className="order-1 lg:order-2">
              <h1 className="text-4xl md:text-5xl text-center font-bold bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent mb-4">
                About Us
              </h1>
              <div className="w-20 h-1 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full mb-6 mx-auto"></div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                At <span className="font-semibold text-indigo-600">Cloud World Institute</span>, our mission is simple — to make every student job-ready for the tech-driven future.
              </p>
          ...
          <section className="bg-gradient-to-bl mt-10 from-indigo-200 via-indigo-50 to-indigo-100 py-16 px-6 rounded-2xl shadow-xl">
            
            <div className="max-w-7xl m-5   ">
              <h2 className="text-4xl font-extrabold text-shadow-md text-center text-indigo-600 mb-12">
          ...
          {/* Our Values Section */}
          <section className="py-16 bg-teal-100 mt-2 rounded-3xl min-h-[60vh]">
          ...
          {/* Bottom CTA */}
          <div className="text-center mt-16 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-2xl p-8 shadow-2xl text-white max-w-4xl mx-auto">
